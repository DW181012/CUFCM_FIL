...
GEN_FLAGS = -I. -Isrc/general -Isrc/flow_field -Isrc/cilia -Isrc/cilia/mobility -Isrc/cufcm -g -w -O3 -lineinfo
CUFCM_ROOT = src/cufcm/
...
HPC_LINK = -lcufft -lcurand -L/usr/lib64 -l:liblapack.so.3.8 -l:libopenblas.so.0 -l:liblapacke.so.3.8 -lstdc++fs
